		...
		return (
			<Layout>
				...
				<section id="experience">
					...
					<p>
						{ i18n.language === 'ru' && 'Кроме этого собрал два сайта на Symphony CMS:' }
						{ i18n.language === 'en' && 'Backend on Symphony CMS:' }
					</p>

					<ul>
						<li><a href="http://jenialubich.com/">
							{ i18n.language === 'ru' && 'Сайт певицы Жени Любич' }
					...
					<p>
						...
						{ i18n.language === 'en' && 'I worked as a coder in the support department. Engaged in the maintenance of client sites on systems ' }
						<a href="https://imprimatur.artlebedev.ru/">Imprimatur и Imprimatur II</a>:
					</p>

					<ul>
						<li><a href="https://www.artlebedev.ru/everything/vbank/site2/">
							{ i18n.language === 'ru' && 'Банк Возрождение' }
							{ i18n.language === 'en' && 'Vozrozhdenie' }
						</a>;</li>
						<li><a href="https://www.artlebedev.ru/everything/gazprom/gazfond-site2/">
							{ i18n.language === 'ru' && 'НПФ «Газфонд»' }
							{ i18n.language === 'en' && 'Gazfond' }
						</a>;</li>
						<li><a href="https://www.artlebedev.ru/everything/caravan/">
							{ i18n.language === 'ru' && 'Караван' }
							{ i18n.language === 'en' && 'Caravan' }
						</a>;</li>
						<li><a href="https://www.artlebedev.ru/everything/medicina/site2/">
							{ i18n.language === 'ru' && 'Медицина' }
							{ i18n.language === 'en' && 'Medicina' }
						</a>;</li>
						<li><a href="https://www.artlebedev.ru/everything/imb/site2/">
							{ i18n.language === 'ru' && 'Международный московский банк' }
							{ i18n.language === 'en' && 'IMB' }
						</a>;</li>
						<li><a href="https://www.artlebedev.ru/everything/nomos/site/">
							{ i18n.language === 'ru' && 'Номос-банк' }
							{ i18n.language === 'en' && 'Nomos' }
						</a>;</li>
						<li><a href="https://www.artlebedev.ru/everything/spb/site2/">
				...
				<section id="education">
					...
					<dl>
						<dt>
							<b>
								{ i18n.language === 'ru' && 'ВГУ им. П. М. Машерова' }
						...
						<dd>
							...
							<br />
							{ i18n.language === 'ru' && 'Специальности: математик-программист, преподаватель математики и информатики' }
							{ i18n.language === 'en' && 'Specialties: software mathematician, teacher of mathematics and computer science' }
						</dd>
					</dl>
				</section>
